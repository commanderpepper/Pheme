...
class RoomTest {
    ...
    private val articleOne = ArticleEntity(publisher = "Android times", title = "This is a test", thumbnail = "picture.png", preview = "This an article", content = "This is an article for real", category = "News")
    ...
    fun writeArticleAndReadInList() = runTest {
        ...
        articleDao.getArticles("News").test {
